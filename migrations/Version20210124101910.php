...
final class Version20210124101910 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `books` (id INT AUTO_INCREMENT NOT NULL, page_nb INT NOT NULL, content LONGBLOB NOT NULL, description VARCHAR(255) NOT NULL, title VARCHAR(80) NOT NULL, price DOUBLE PRECISION NOT NULL, cover VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, author VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
